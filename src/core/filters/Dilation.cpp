// core/filters/Dilation.cpp
#include "Dilation.h"
#include "core/QMat.h"

namespace core::filters {

    QImage Dilation::run(const QImage& src) const{
        QImage dst = src.copy();
        QMat in(src), out(dst);
    ...
    void Dilation::buildUI(QWidget* panel, const std::function<void()>& refresh){
        ...
        auto* group = new QGroupBox(QObject::tr("Dilation Settings"), outer);
        ...
        spin->setRange(1, 5);  // kernel radius
